...
I work at the intersection of **robotics**, **machine learning**, and **computer vision** to help autonomous systems better understand and navigate the world around them. Most recently, I'm interested in exploring reliable sim and eval methods that can help to answer the question **"Is the autonomous system safe?"** before the actual deployment. With the development of generative AI and as some autonomous systems (autonomous vehicles etc.) are ready to scale in a dynamic and unstructured world, I truly believe this is a crucial aspect to focus on.

Most recently, I spent time at [Zoox Inc.](https://zoox.com/), honorably supervised by [Eric Schafer](https://www.linkedin.com/in/eric-schafer-1636853) and [Dr. Phillipe Burlina](https://resvirtualis.github.io/) to work on generative sensor simulation for autonomous vehicles. Earlier, I was at [LifeFoundry Inc.](https://www.life-foundry.com/), working on real-time vision-based perception system for AGVs. 
